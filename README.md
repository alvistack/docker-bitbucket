...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/bitbucket-9.2.svg)](https://hub.docker.com/r/alvistack/bitbucket-9.2)
...
- [`alvistack/bitbucket-9.2`](https://hub.docker.com/r/alvistack/bitbucket-9.2)
  - [`packer/docker-9.2/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-9.2/packer.json)
...
Start Atlassian Bitbucket Server:
    ...
    # Pull latest image
    docker pull alvistack/bitbucket-9.2
