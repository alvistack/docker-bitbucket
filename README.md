...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/bitbucket-7.20.svg)](https://hub.docker.com/r/alvistack/bitbucket-7.20)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/bitbucket-7.20`](https://hub.docker.com/r/alvistack/bitbucket-7.20)
      - [`packer/docker-7.20/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-7.20/packer.json)
  - [`alvistack/bitbucket-7.19`](https://hub.docker.com/r/alvistack/bitbucket-7.19)
      - [`packer/docker-7.19/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-7.19/packer.json)
...
Start Atlassian Bitbucket Server:
    ...
    # Pull latest image
    docker pull alvistack/bitbucket-7.20
