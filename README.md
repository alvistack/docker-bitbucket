...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/bitbucket-9.5.svg)](https://hub.docker.com/r/alvistack/bitbucket-9.5)
...
- [`alvistack/bitbucket-9.5`](https://hub.docker.com/r/alvistack/bitbucket-9.5)
  - [`packer/docker-9.5/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-9.5/packer.json)
...
Start Atlassian Bitbucket Server:
    ...
    # Pull latest image
    docker pull alvistack/bitbucket-9.5
