...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/bitbucket-7.16.svg)](https://hub.docker.com/r/alvistack/bitbucket-7.16)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/bitbucket-7.15`](https://hub.docker.com/r/alvistack/bitbucket-7.15)
      - [`packer/docker-7.15/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-7.15/packer.json)
...
Start Atlassian Bitbucket Server:
    ...
    # Pull latest image
    docker pull alvistack/bitbucket-7.16
