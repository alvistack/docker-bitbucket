...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/bitbucket-8.14.svg)](https://hub.docker.com/r/alvistack/bitbucket-8.14)
...
-   [`alvistack/bitbucket-8.14`](https://hub.docker.com/r/alvistack/bitbucket-8.14)
    -   [`packer/docker-8.14/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-8.14/packer.json)
-   [`alvistack/bitbucket-8.13`](https://hub.docker.com/r/alvistack/bitbucket-8.13)
    -   [`packer/docker-8.13/packer.json`](https://github.com/alvistack/docker-bitbucket/blob/master/packer/docker-8.13/packer.json)
...
Start Atlassian Bitbucket Server:
    ...
    # Pull latest image
    docker pull alvistack/bitbucket-8.14
