...
ENV BITBUCKET_DOWNLOAD_URL       "https://downloads.atlassian.com/software/stash/downloads/atlassian-bitbucket-5.13.0.tar.gz"
...
RUN set -ex \
    ...
    && tar zxf $ARCHIVE --strip-components=1 -C $BITBUCKET_CATALINA/app/WEB-INF/lib/ mysql-connector-java-8.0.11/mysql-connector-java-8.0.11.jar \
    && rm -rf $ARCHIVE
